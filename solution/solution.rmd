...
This means the number of iterations of the BFS exploration must also grow exponentially, dominating overall complexity.
i.e. despite final representation size is only O(N), we won't make it there.
